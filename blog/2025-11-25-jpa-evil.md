...
And thus JPA was born. Not an actual implementation, mind you! Just a specification. A set of APIs that framework developers could implement. Hibernate said "*bet*", EclipseLink said "*sure*", and suddenly we were living in the future.

You just slap `@Entity` on your class, sprinkle some `@Column` annotations, and boom! We have the framework handles the mapping. No more copying column values like a medieval scribe.
...
The performance cost was like paying 50 cents extra for guac. Yeah, technically you're paying more, but *come on*, it's guac.
...
So you learn about Entity Graphs. Great! Now you have to declare every possible loading scenario upfront like you're planning a heist.
