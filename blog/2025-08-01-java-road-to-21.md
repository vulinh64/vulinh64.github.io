...
<TabItem value="with-var-keyword" label="With 'var' Keyword">
...
<TabItem value="without-var-keyword" label="With Explicit Type Inference">
...
The supporting `boolean isLeapYear(int)` method:
...
Now to get the correct days of a certain month in a certain year:

<Tabs>

<TabItem value="new-switch-case" label="Enhanced Switch Expression">
...
<TabItem value="old-switch-case" label="Old School Way">
...
Text block allows you to write "beautiful" string literal without (most of the time) the ugly escape characters:

<Tabs>

<TabItem value="text-block" label="Blyatiful Text Block">
...
<TabItem value="literal-string" label="Ugly String Literal">
...
Let's implement a method to print the info of the vehicle based on its actual implementation:
...
<TabItem value="without-pattern-matching" label="Without Pattern Matching">
...
<TabItem value="use-pattern-matching-switch-expression" label="Pattern Matching for Switch Expression">
...
<TabItem value="pattern-matching-instanceof" label="Pattern Matching for Instance Check">
...
<TabItem value="record-pattern" label="With Record Patterns">
...
<TabItem value="without-record-pattern" label="Without Record Patterns">
...
<TabItem value="record-pattern-2" label="With Record Patterns">
...
<TabItem value="without-record-pattern-2" label="Without Record Patterns">
